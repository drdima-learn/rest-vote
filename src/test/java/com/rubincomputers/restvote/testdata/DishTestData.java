...
public class DishTestData {
    ...
    public static final Dish dish1 = new Dish(DISH1_ID, "dish1 - rest1", 101, LocalDate.now());
    ...
    public static Dish getNew() {
        return new Dish(null, "New Dish", 1000, LocalDate.now(), RestaurantTestData.rest1);
    }
